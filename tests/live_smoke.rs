...
//!
//! Run with output: `cargo test --test live_smoke -- --nocapture`.

use std::net::TcpStream;
use std::time::Duration;

use bee::config::{ProviderConfig, ProviderType};
use bee::provider::rig_model::RigModel;
use bee::{Conversation, Model};
