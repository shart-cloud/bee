...
use bee_harness::repl::{run_exchange, ReplOutput, SteeringQueue};
use bee_harness::sandbox::{self, Sandbox};
use bee_harness::tools::registry_for;
use bee_harness::{Conversation, ReplConfig, ToolCall, Turn};
...
impl ReplOutput for WidgetCapture {
    ...
    fn tool_result(&self, _result: &bee_harness::ToolResult, _audit: &[bee_core::AuditEvent]) {}
